...
janelaGeral = plt.figure(figsize=(7, 6), facecolor='#EEE') # cria a janela com o tamanho e a cor
...
animacaoGeral = FuncAnimation(janelaGeral, definirGraficos, interval=1000)
